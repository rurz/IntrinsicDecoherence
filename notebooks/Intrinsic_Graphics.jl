...
md"## Intrinsic decoherence assisted energy transfer"
...
begin
	...
	axs1.text(70, 0, L"(a)", fontsize=14)
	axs2.text(70, 0, L"(b)", fontsize=14)
	axs3.text(70, 0, L"(c)", fontsize=14)
	...
	axins.set_xlim([0,8])
	axins.set_title(L"Close view $0 \leq t \leq 5$", fontsize = 12)
...
begin
	...
	axS1.text(6.9, 0, L"(a)", fontsize=14)
	axS2.text(6.9, 0, L"(b)", fontsize=14)
	axS3.text(6.9, 0, L"(c)", fontsize=14)
