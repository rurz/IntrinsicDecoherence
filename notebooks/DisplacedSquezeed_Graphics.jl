...
begin
	tsq1 = [quads_a(α, r, 0, 0.7, ω, 10, tlist[τ]) for τ in 1:length(tlist)];
	tsq2 = [quads_a(α, r, 0, 0.7, ω, 10, tlist[τ]) for τ in 1:length(tlist)];
	tsq3 = [quads_a(α, r, 0, 0.7, ω, 10, tlist[τ]) for τ in 1:length(tlist)];
end;
...
begin
	tSq1 = [nums_a(α, r, 0, 0.7, ω, 10, tlist[τ]) for τ in 1:length(tlist)];
	tSq2 = [nums_a(α, r, 0, 0.7, ω, 10, tlist[τ]) for τ in 1:length(tlist)];
	tSq3 = [nums_a(α, r, 0, 0.7, ω, 10, tlist[τ]) for τ in 1:length(tlist)];
end;
